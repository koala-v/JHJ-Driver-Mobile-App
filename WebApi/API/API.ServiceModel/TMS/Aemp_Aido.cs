            ...
            try
            {
                using (var db = DbConnectionFactory.OpenDbConnection("TMS"))
                {
                    ...
                    strSql = "Select * From(  select cast(TrxNo as varchar(20)) as 'Key','Aemp1' as TableName, 'Collect' as DCFlag ,'' as UpdatedFlag ,isnull((cast(pcs as nvarchar(20))+' ' +ISNULL(UomCode,'')),'') as PcsUom ," +
                        ...
                        "  CollectDateTime as TimeFrom  ,  DeliverToname as DeliveryToName, DeliverToAddress1 as DeliveryToAddress1 , " +
                        "  DeliverToAddress2 as DeliveryToAddress2 ,DeliverToAddress3 as DeliveryToAddress3 ,DeliverToAddress4 as DeliveryToAddress4 , " +
